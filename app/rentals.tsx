              ...
              executeConcurrently(
                  async () => {
                    try {
                      ...
                      logError("Error ending rental", error);
...
// Handle the result separately
    ...
    }, 2000); // Show processing state for at least 2 seconds
                  ...
                  <View style={styles.rentalInfoContainer}>
                    ...
                    <View style={styles.infoRow}>
                      ...
                      <Text style={[styles.infoValue, {
                        color: "#FFFFFF",
                        fontWeight: "500"
                      }]}>{activeRental.startStation}</Text>
                    </View>
                    <View style={styles.infoRow}>
                ...
                <View style={styles.noRentalContainer}>
                  ...
                  >
                    <View style={styles.achievementsHeader}>
                      <Text
                          style={[styles.achievementsTitle, {color: "#FFFFFF", fontWeight: "bold"}]}>Achievements</Text>
